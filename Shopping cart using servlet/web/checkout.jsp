...
<body>
<div id="banner"><img id="img-icon" src="resources/images/hubwifee.gif" alt=""><img id="img-banner" src="resources/images/kelati.png" alt=""><marquee><span>Welcome to Huby-wifee Shop</span></marquee></div>
...
<h2> Cart Total $ <span id="totalPrice"><c:out value="${totalPrice}"/></span></h2>
 ...
 <form name="bill-form" method="POST">
    <div id="main">
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="radio" name="card" />  <img src="resources/images/master.jpeg" width="70px" />
                </div>
    ...
    <div id="message-box">
        ...
        <a href="productList"> Continute shopping ... </a>
